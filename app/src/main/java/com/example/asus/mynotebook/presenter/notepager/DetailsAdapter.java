...
public class DetailsAdapter extends RecyclerView.Adapter<DetailsAdapter.ViewHolder> {
    ...
    private FrameLayout update_frag;
    public ArrayList<NoteBean> noteLists;
    private boolean isDeleteAble = true;
    private View inflate;
    private final FragmentManager fragmentManager;

    public DetailsAdapter(List list, Context context, FragmentManager supportFragmentManager){
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            update_frag = itemView.findViewById(R.id.update_note_frg);
        }
    }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch (items[which]) {
                            ...
                            case "修改":
                                ...
                                UpdateNoteFragment upFg = new UpdateNoteFragment();
                                Bundle bundle = new Bundle();
                                bundle.putString("Data" ,viewHolder.title.getText().toString());
                                upFg.setArguments(bundle);
                                ft.replace(R.id.update_note_frg,upFg);
                                ft.commit();
                            default:
